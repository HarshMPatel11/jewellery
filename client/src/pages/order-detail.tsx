        ...
        <div className="md:col-span-1 space-y-6">
          <div className="border border-border p-6 bg-card">
            ...
            <div className="space-y-2 text-sm mb-4">
              ...
              <div className="flex justify-between text-muted-foreground">
                <span>Payment</span>
                <span className="capitalize">{(order as any).paymentMethod ?? "cod"}</span>
              </div>
              <div className="flex justify-between text-muted-foreground">
                <span>Payment Status</span>
                <span className="capitalize">{((order as any).paymentStatus ?? "pending").replace("_", " ")}</span>
              </div>
            </div>
          ...
          <div className="border border-border p-6 bg-card">
            <h2 className="font-serif text-lg mb-3">Returns & Support</h2>
            <p className="text-sm text-muted-foreground mb-4">
              Need help with this order? Raise a return/refund request and the team will review it from admin.
            </p>
            <Button variant="outline" className="w-full rounded-none" asChild>
              <Link href={`/return-request?orderId=${order.id}`}>Request Return</Link>
            </Button>
          </div>
        </div>
      </div>
